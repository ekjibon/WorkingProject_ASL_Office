...
{
    public class TransactionDetailRepository : BaseRepository<TransactionDetail>,  IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();
        public TransactionDetailRepository() : base(_context = new ModelDbContext())
        {
           // Context = _context;
        }
