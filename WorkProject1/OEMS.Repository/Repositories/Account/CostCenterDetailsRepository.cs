...
{
    public class CostCenterDetailsRepository : BaseRepository<CostCenterDetails>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public CostCenterDetailsRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;
        }
