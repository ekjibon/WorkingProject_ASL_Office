...
{
   public class SalaryTaxYearRepository : BaseRepository<SalaryTaxYear>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public SalaryTaxYearRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;  
        }
