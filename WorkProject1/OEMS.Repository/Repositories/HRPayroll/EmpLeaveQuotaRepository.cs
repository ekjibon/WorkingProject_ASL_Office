...
{
    public class EmpLeaveQuotaRepository : BaseRepository<EmpLeaveQuota>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public EmpLeaveQuotaRepository() : base(_context = new ModelDbContext()) 
        {
            // Context = _context;
