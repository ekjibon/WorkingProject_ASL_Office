...
{
   public class SalaryIncrementRepository : BaseRepository<SalaryIncrement>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public SalaryIncrementRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;  
        }
