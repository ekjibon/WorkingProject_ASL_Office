...
{
   public class LeaveRoutingHistoryRepository: BaseRepository<LeaveRoutingHistory>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public LeaveRoutingHistoryRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context; 
        }
