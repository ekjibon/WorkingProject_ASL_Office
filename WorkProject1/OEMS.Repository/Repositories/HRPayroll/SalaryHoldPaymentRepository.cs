...
{
    public class SalaryHoldPaymentRepository : BaseRepository<SalaryHoldPayment>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public SalaryHoldPaymentRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;  
        }
