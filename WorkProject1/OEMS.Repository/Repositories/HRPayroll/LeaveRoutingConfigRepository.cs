...
{
   public class LeaveRoutingConfigRepository: BaseRepository<LeaveRoutingConfig>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public LeaveRoutingConfigRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context; 
        }
