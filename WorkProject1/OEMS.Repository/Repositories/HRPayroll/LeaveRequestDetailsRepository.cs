...
{
   public class LeaveRequestDetailsRepository: BaseRepository<LeaveRequestDetails>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public LeaveRequestDetailsRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context; 
        }
