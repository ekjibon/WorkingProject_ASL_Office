...
{
    public class AdvanceSalaryPaymentRepository : BaseRepository<AdvanceSalaryPayment>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public AdvanceSalaryPaymentRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;  
        }
        ...
        ~AdvanceSalaryPaymentRepository() 
        {
