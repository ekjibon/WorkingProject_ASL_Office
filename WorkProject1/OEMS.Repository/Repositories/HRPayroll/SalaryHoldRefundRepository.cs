...
{
   public class SalaryHoldRefundRepository : BaseRepository<SalaryHoldRefund>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public SalaryHoldRefundRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;  
        }
