...
{
    public class SalaryEmployeeRepository : BaseRepository<SalaryEmployee>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public SalaryEmployeeRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;   
        }
