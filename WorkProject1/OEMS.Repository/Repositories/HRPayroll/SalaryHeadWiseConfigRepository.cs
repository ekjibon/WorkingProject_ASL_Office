...
{
    public class SalaryHeadWiseConfigRepository : BaseRepository<SalaryHeadWiseConfig>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public SalaryHeadWiseConfigRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;  
        }
        ...
        ~SalaryHeadWiseConfigRepository()
        {
