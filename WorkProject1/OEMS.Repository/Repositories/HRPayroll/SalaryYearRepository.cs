...
{
   public class SalaryYearRepository : BaseRepository<SalaryYear>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public SalaryYearRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;  
        }
