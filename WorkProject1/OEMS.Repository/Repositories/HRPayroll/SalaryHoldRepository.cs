...
{
    public class SalaryHoldRepository : BaseRepository<SalaryHold>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public SalaryHoldRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;  
        }
