...
{
    public class InvoiceBillingMethodRepository : BaseRepository<InvoiceBillingMethod>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public InvoiceBillingMethodRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;
        }
        ...
        ~InvoiceBillingMethodRepository()
        {
