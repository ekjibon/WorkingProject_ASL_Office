...
{
    public class InvoiceCollectionMasterRepository : BaseRepository<InvoiceCollectionMaster>, IDisposable 
    {
        public static ModelDbContext _context = new ModelDbContext();

        public InvoiceCollectionMasterRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context; 
        }
        ...
        ~InvoiceCollectionMasterRepository()
        {
