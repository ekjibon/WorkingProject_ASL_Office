...
{
    public class InvoiceGenerateRepository : BaseRepository<InvoiceGenerate>, IDisposable 
    {
        public static ModelDbContext _context = new ModelDbContext();

        public InvoiceGenerateRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context; 
        }
