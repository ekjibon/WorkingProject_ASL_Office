...
{
    public class InvoicePrintMasterRepository : BaseRepository<InvoicePrintMaster>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public InvoicePrintMasterRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;
        }
