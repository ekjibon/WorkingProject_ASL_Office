...
{
    public class InvoiceBillingHeadRepository : BaseRepository<InvoiceBillingHead>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public InvoiceBillingHeadRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;
        }
