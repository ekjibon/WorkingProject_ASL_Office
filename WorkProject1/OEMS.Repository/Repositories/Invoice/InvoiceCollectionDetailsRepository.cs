...
{
    public class InvoiceCollectionDetailsRepository : BaseRepository<InvoiceCollectionDetails>, IDisposable 
    {
        public static ModelDbContext _context = new ModelDbContext();

        public InvoiceCollectionDetailsRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context; 
        }
        ...
        ~InvoiceCollectionDetailsRepository()
        {
