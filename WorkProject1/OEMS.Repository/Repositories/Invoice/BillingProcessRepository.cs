...
{
    public class BillingProcessRepository : BaseRepository<BillingProcess>, IDisposable 
    {
        public static ModelDbContext _context = new ModelDbContext();

        public BillingProcessRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context; 
        }
