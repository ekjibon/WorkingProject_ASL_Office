...
{
    public class PhoneCallMaintainRepository : BaseRepository<PhoneCallMaintain>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public PhoneCallMaintainRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;
        }
