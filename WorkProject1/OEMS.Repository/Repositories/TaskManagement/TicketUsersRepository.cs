...
{
    public class TicketUsersRepository : BaseRepository<TicketUsers>,  IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();
       
        public TicketUsersRepository() : base(_context = new ModelDbContext())
        {
           // Context = _context;
        }
