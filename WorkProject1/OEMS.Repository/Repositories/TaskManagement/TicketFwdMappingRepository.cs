...
{
    public class TicketFwdMappingRepository : BaseRepository<TicketFwdMapping>,  IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();
       
        public TicketFwdMappingRepository() : base(_context = new ModelDbContext())
        {
           // Context = _context;
        }
