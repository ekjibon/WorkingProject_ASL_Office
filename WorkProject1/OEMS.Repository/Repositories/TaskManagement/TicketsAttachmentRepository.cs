...
{
    public class TicketsAttachmentRepository : BaseRepository<TicketsAttachment>,  IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();
       
        public TicketsAttachmentRepository() : base(_context = new ModelDbContext())
        {
           // Context = _context;
        }
