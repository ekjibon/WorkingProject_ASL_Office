...
{
    public class BugAttachmentRepository : BaseRepository<BugAttachment>,  IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();
       
        public BugAttachmentRepository() : base(_context = new ModelDbContext())
        {
           // Context = _context;
        }
