...
{
    public class UserAccBranchRepository : BaseRepository<UserAccBranch>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public UserAccBranchRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;
        }
