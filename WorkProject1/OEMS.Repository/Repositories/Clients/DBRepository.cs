...
namespace OEMS.Repository.Repositories.Clients
{
    public class DBRepository : BaseRepository<Clients_db>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public DBRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;
        }
