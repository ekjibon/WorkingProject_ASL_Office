...
{
    public class SMSExtNumbersRepository : BaseRepository<SMSExtNumbers>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public SMSExtNumbersRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;
        }
