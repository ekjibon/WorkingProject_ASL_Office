...
{
    public class ScheduleSMSConfigRepository : BaseRepository<ScheduleSMSConfig>,  IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();
       
        public ScheduleSMSConfigRepository() : base(_context = new ModelDbContext())
        {
           // Context = _context;
        }
