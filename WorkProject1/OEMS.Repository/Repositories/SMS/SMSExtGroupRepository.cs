...
{
    public class SMSExtGroupRepository : BaseRepository<SMSExtGroup>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public SMSExtGroupRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;
        }
