...
{
    public class SMSTempTagRepository : BaseRepository<SMSTempTag>, IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();

        public SMSTempTagRepository() : base(_context = new ModelDbContext())
        {
            // Context = _context;
        }
