...
{
    public class SMSSendHistroyRepository : BaseRepository<SMSSendHistroy>,  IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();
       
        public SMSSendHistroyRepository() : base(_context = new ModelDbContext())
        {
           // Context = _context;
        }
