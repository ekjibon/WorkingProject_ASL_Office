...
{
    public class ReportHeaderImageRepository : BaseRepository<ReportHeader>,  IDisposable
    {
        public static ModelDbContext _context = new ModelDbContext();
       
        public ReportHeaderImageRepository() : base(_context = new ModelDbContext())
        {
           // Context = _context;
        }
