...
namespace OEMS.Repository.Helpers
{
    public static class LogHelper
    {
        ...
        static LogHelper()
        {
            ...
            // options.AdditionalDataColumns.Add(new System.Data.DataColumn("UserName", typeof(string)));
        ...
        public static void Error(Exception ex , string Message)
        {
            ...
            Log.Write(LogEventLevel.Error, ex.Message +"{0}",Message);
        }
        ...
        public static void Error(DbEntityValidationException e)
        {
            ...
            Log.Write(LogEventLevel.Error, fullErrorMessage);
        }

        public static void Warning(Exception ex, string message)
        {
            //Warning - indicators of possible issues or service / functionality degradation
            Log.Write(LogEventLevel.Warning, ex, message);
        }
        ...
        public static void Debug(Exception ex, string message)
        {
            ...
            Log.Write(LogEventLevel.Debug, ex, message);
        }
        ...
        public static void Information(string message)
        {
            ...
            string UserId = HttpContext.Current.User.Identity.GetUserName();
