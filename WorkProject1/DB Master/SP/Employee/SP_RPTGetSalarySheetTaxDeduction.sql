...
GO
/****** Object:  StoredProcedure [dbo].[SP_RPTGetSalarySheetTaxDeduction]    Script Date: 4/22/2020 11:03:20 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
	--- EXEC SP_RPTGetSalarySheetTaxDeduction 2,8
ALTER PROCEDURE [dbo].[SP_RPTGetSalarySheetTaxDeduction] 
(
@PeriodId INT,
@BranchID INT = 0
)
