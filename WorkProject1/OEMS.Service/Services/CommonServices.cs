...
namespace OEMS.Service.Services
{
    public class CommonServices: IServiceCommon
    {
        ...
        {
            return this.commonRepository.WriteLog(Vid, SId, ShId, ClassId, GroupId, MainExamId, Pid, Msg, AddBy,SectionId);
        }
        public bool WriteLog(int SId, int ClassId, int MainExamId, int Type, string PID, string Msg, string AddBy,int SectionId)
        {
            return this.commonRepository.WriteLog( SId, ClassId, MainExamId,Type, PID, Msg, AddBy, SectionId);
        }
